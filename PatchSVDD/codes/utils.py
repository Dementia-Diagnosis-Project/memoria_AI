...
__all__ = ['crop_image_CHW', 'PatchDataset_NCHW', 'NHWC2NCHW_normalize', 'to_device', 'NHWC2NCHW', 
...
# 데이터세트를 딕셔너리로 관리하고자 할 때 사용하는 클래스
...
# 패치를 생성하기 위한 좌표 정보에 따라 K*K 크기의 이미지 패치 생성
